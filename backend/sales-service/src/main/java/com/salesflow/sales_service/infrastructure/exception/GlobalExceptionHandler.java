package com.salesflow.sales_service.infrastructure.exception;

import com.salesflow.sales_service.application.exceptions.models.ErrorResponse;
import com.salesflow.sales_service.application.exceptions.types.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ProposalNotAllowedException.class)
    public ResponseEntity<ErrorResponse> handleNotFound(ProposalNotAllowedException ex) {
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(ErrorResponse.of(ex.getCode(), ex.getMessage()));
    }
